...
The table below shows the industry and sectors which list the Foreign Language as an important skill. 
...
htmlwidgets::prependContent(table, h2(class = "title", "Industry and sectors ranking 'Foreign Language' amongst top skills"))
```
